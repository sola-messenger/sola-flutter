...
class IgnoreBoxDecoration extends Decoration {
  ...
  IgnoreBoxDecoration copyWith({
    ...
    BoxShape? shape,
    EdgeInsets? ignorePadding,
  }) {
    return IgnoreBoxDecoration(
      ...
      ignorePadding: ignorePadding ?? this.ignorePadding,
    );
  }
  ...
  final EdgeInsets? ignorePadding;
  ...
  ///
  /// The [shape] cannot be interpolated; animating between two [IgnoreBoxDecoration]s
  ...
  Path getClipPath(Rect rect, TextDirection textDirection) {
    if (ignorePadding != null) {
      rect = Rect.fromLTWH(
          rect.left - (ignorePadding?.left ?? 0.0),
          rect.top - (ignorePadding?.top ?? 0.0),
          rect.width +
              (ignorePadding?.right ?? 0.0) +
              (ignorePadding?.left ?? 0.0),
          rect.height +
              (ignorePadding?.bottom ?? 0.0) +
              (ignorePadding?.top ?? 0.0));
    }
    switch (shape) {
  ...
  IgnoreBoxDecoration scale(double factor) {
    return IgnoreBoxDecoration(
  ...
  @override
  IgnoreBoxDecoration? lerpFrom(Decoration? a, double t) {
    if (a == null) return scale(t);
    if (a is IgnoreBoxDecoration) return IgnoreBoxDecoration.lerp(a, this, t);
    return super.lerpFrom(a, t) as IgnoreBoxDecoration?;
  }

  @override
  IgnoreBoxDecoration? lerpTo(Decoration? b, double t) {
    if (b == null) return scale(1.0 - t);
    if (b is IgnoreBoxDecoration) return IgnoreBoxDecoration.lerp(this, b, t);
    return super.lerpTo(b, t) as IgnoreBoxDecoration?;
  }
  ...
  static IgnoreBoxDecoration? lerp(
      IgnoreBoxDecoration? a, IgnoreBoxDecoration? b, double t) {
  ...
  bool operator ==(Object other) {
    ...
    return other is IgnoreBoxDecoration &&
        other.color == color &&
        other.image == image &&
        other.border == border &&
...
/// An object that paints a [IgnoreBoxDecoration] into a canvas.
class _BoxDecorationPainter extends BoxPainter {
  _BoxDecorationPainter(this._decoration, VoidCallback? onChanged)
      : super(onChanged);

  final IgnoreBoxDecoration _decoration;
  ...
  void paint(Canvas canvas, Offset offset, ImageConfiguration configuration) {
    ...
    if (_decoration.ignorePadding != null) {
      rect = Rect.fromLTWH(
          rect.left - (_decoration.ignorePadding?.left ?? 0.0),
          rect.top - (_decoration.ignorePadding?.top ?? 0.0),
          rect.width +
              (_decoration.ignorePadding?.right ?? 0.0) +
              (_decoration.ignorePadding?.left ?? 0.0),
          rect.height +
              (_decoration.ignorePadding?.bottom ?? 0.0) +
              (_decoration.ignorePadding?.top ?? 0.0));
    }
