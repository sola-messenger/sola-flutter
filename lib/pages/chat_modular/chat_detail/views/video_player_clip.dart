...
import 'image_bubble_clip.dart';


class VideoPlayerClip extends StatefulWidget {
  final Event event;
  const VideoPlayerClip(this.event, {Key? key}) : super(key: key);

  @override
  VideoPlayerClipState createState() => VideoPlayerClipState();
}

class VideoPlayerClipState extends State<VideoPlayerClip> {
